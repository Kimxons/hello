$(document).ready(function() {
    ...
    var CONSTANTS = {
        ...
        ADD_PRODUCT_BUTTON: "addProduct",
        RETRIEVE_PRODUCT_ADDRESS_MENU_BUTTON: "#retrieveProductAddressMenuButton",
    ...
    $(CONSTANTS.HOME_TENDER_DOCS_MENU_BUTTON).click(function() {
        displayRow(CONSTANTS.HOW_IT_WORKS, CONSTANTS.EMPTY_STRING)
    });
    // display the upload tender docs row after menu button click
    $(CONSTANTS.UPLOAD_TENDER_DOCS_MENU_BUTTON).click(function() {
        displayRow(CONSTANTS.UPLOAD_TENDER_DOCS,
            CONSTANTS.UPLOAD_TENDER_DOCS_FORM)
    });
    // display the verify tender docs row  after menu button click
    $(CONSTANTS.VERIFY_TENDER_DOCS_MENU_BUTTON).click(function() {
        displayRow(CONSTANTS.VERIFY_TENDER_DOCS,
            CONSTANTS.VERIFY_TENDER_DOCS_FORM)
    });
    // display the retrieve tender docs row  after menu button click
    $(CONSTANTS.RETRIEVE_TENDER_DOCS_ADDRESS_MENU_BUTTON).click(function() {
        displayRow(CONSTANTS.RETRIEVE_TENDER_DOCS_ADDRESS,
    ...
    $(CONSTANTS.GET_TENDER_DOCS_COUNT_MENU_BUTTON).click(function() {
        displayRow(CONSTANTS.GET_TENDER_DOCS_COUNT_ROW,
    ...
    $(CONSTANTS.CHECK_CONTRACT_STATUS_MENU_BUTTON).click(function() {
        displayRow(CONSTANTS.CHECK_CONTRACT_STATUS_ROW,
            CONSTANTS.EMPTY_STRING)
    });
